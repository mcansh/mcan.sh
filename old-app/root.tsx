...
export function ErrorBoundary() {
  ...
  return isRouteErrorResponse(error) ? (
    ...
    <div className="space-y-4">
      ...
      <p>If you are not the developer, please click back in your browser and try again.</p>
      ...
      <details className="space-y-4">
        ...
        {import.meta.env.PROD ? (
          <p>
            There was an uncaught exception in your application. Check the browser console and/or
            the server console to inspect the error.
          </p>
        ) : (
