...
import type { EntryContext, HandleDataRequestFunction, RouterContextProvider } from "react-router"
...
export default async function handleRequest(
  ...
  let { nonce, headers } = applySecurityHeaders(loadContext, request, responseHeaders)
...
function applySecurityHeaders(
  ...
  let upgradeInsecureRequests = import.meta.env.PROD && !url.host.includes("localhost")
