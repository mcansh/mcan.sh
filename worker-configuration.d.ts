/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f08c2157b693f79bd3c8889a49938c8b)
// Runtime types generated with workerd@1.20250927.0 2025-05-05 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	...
	interface Env {
		...
		SENTRY_REPORT_URL: string;
		CLOUDFLARE_API_TOKEN: string;
		CLOUDFLARE_EMAIL: string;
		VITE_FATHOM_SITE_ID: string;
		VITE_REACT_SCAN_API_KEY: string;
		VITE_REACT_SCAN_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "CLOUDINARY_CLOUD_NAME" | "VITE_SENTRY_DSN" | "SENTRY_REPORT_URL" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_EMAIL" | "VITE_FATHOM_SITE_ID" | "VITE_REACT_SCAN_API_KEY" | "VITE_REACT_SCAN_URL" | "RAILWAY_GIT_BRANCH" | "RAILWAY_DEPLOYMENT_ID">> {}
}
